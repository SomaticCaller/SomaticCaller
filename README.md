...
The output of SomaticCaller is a VCF (Variant Call Format) file, conforming to the VCFv4.2 standard. This VCF file is generated by the recommended somatic variant caller, integrated within SomaticCaller. 
